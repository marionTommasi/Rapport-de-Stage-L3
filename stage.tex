...
%montrer sur exemple en quoi c'est redondant
...
Pour la redondance des calculs, la première idée a été de calculer la position des motifs par blocs, %expliquer comment.
