...
En 2000, Paolo Ferragina et Giovanni Manzini\up{\cite{fmindex}} créent une structure d'indexation, appelée FM-index, basée sur la \bwt.
...
% Cette association, appelée fonction LF()(voir figure \ref{lf}), est calculée de la façon suivante :
