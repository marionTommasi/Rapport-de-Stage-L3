...
\begin{figure}[!ht]
    ...
    \caption{Exemple de chromatographie | source : aconthoweb...}
    \label{chromato}
\end{figure}
...
Le \textit{wavelet tree}, ou arbre d'ondelettes, est une structure de données succincte (c'est-à-dire stockée optimalement), à l'origine utilisée pour représenter les tableaux de suffixes compressés, permettant de stocker des chaînes de caractères.
